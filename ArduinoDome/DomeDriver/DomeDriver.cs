...
namespace ASCOM.NANO.Dome
{
    ...
    //
    // Your driver's DeviceID is ASCOM.NANO.Dome
    //
    // The COM Guid attribute sets the CLSID for ASCOM.NANO.Dome
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("41305059-cddb-43fc-953d-b281d585b4c5")]
    [ProgId("ASCOM.NANO.Dome")]
    [ServedClassName("ASCOM Dome Driver for NANO")] // Driver description that appears in the Chooser, customise as required
